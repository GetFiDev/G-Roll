# Critical Surfaces - G-Roll

**Version:** 2.0
**Last Updated:** 2026-01-14
**Purpose:** Define areas requiring explicit change protocol

---

## What is a Critical Surface?

A **critical surface** is any code area where bugs cause:

1. 🚨 **Game Unplayable:** Users cannot launch or play the game
2. 💰 **Revenue Loss:** Purchases fail, fraud occurs, or incorrect entitlements granted
3. 🔥 **Data Corruption:** User progress lost or corrupted
4. 🔐 **Security Breach:** Unauthorized access or data leaks

---

## Touch Protocol

### ⚠️ Updated Philosophy (January 2026)

**Old Approach:** "Never touch these areas"
**New Approach:** "Touch only with explicit plan and approval"

---

### Change Protocol for Critical Surfaces
...
2. **Get Approval**
   - Level 0: Requires explicit "proceed" confirmation
   - Level 1 (Feature): Show plan, wait for feedback
   - Level 1 (Fix): Can proceed after posting plan (implicit approval)

3. **Implement with Constraints**
   - Minimal diff (smallest possible change)
   - One logical change per commit
   - Test before committing (SMOKE.md items)

4. **Document Changes**
   - Update FLOWS.md if flow changes
   - Update COMPONENTS.md if architecture changes
   - Add backlog item if workaround applied
